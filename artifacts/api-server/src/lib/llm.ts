...
export async function runLlmCopilot(
 ...
 "CCTP bridge (USDC only, Stellar Testnet → Base/Eth Sepolia): cctp_bridge. sendAmount=USDC amount, destination=0x EVM address, destAsset=base|ethereum (or marketHint). Example: bridge 1 USDC to base sepolia 0x…. Do NOT say Orbit cannot bridge when they ask to bridge USDC via CCTP/Circle.",
