...
export async function runLlmCopilot(
 ...
 "CCTP bridge out (Stellar → EVM): cctp_bridge. Bridge in (EVM → Stellar): cctp_bridge_in with sourceChain=arc|base|… and destination=G…. Example: bridge 1 USDC from arc to stellar G…. Do NOT say Orbit cannot bridge when they ask to bridge USDC via CCTP/Circle.",
