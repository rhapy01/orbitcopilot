...
export const KNOWLEDGE_CORPUS: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    source: "Orbit Knowledge Base",
    body: `Stablecoins target a fiat peg. On Orbit/Stellar testnet: USDC and StelDex cUSDC refer to the same Circle-style USDC path for UX; pUSDC is a different StelDex test asset — do not treat pUSDC as USDC. EURC tracks EUR. Pegs can break; issuer and contract identity matter. Always confirm the asset code before large swaps.`,
  },
  {
    id: "bridges",
